...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Timeless Bharat - Explore India</title>
    ...
    <body>
        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="m-0"><i class="fa fa-map-marker-alt me-3"></i>TimeLess Bharat</h1>
                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    ...
                                    <p class="mb-5 fs-5">Explore Indias beauty and all the heritages sites. 
                                    </p>
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    ...
                                    <p class="mb-5 fs-5">The beauty of travel lies in ability to transform us. 
                                    </p>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="#">Discover Now</a>
                                    </div>
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    ...
                                    <p class="mb-5 fs-5">Travel is to dream with open eyes.  
                                    </p>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="#">Discover Now</a>
                                    </div>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(img/about-img-1.png);">
                        ...
                        <h1 class="mb-4">Welcome to <span class="text-primary">Timeless Bharat</span></h1>
                        <b>
                        <p class="mb-4">At Timeless Bharat, we believe travel is not just about destinations—it’s about the stories, the people, and the timeless spirit that lives in every corner of our incredible country. Our mission is to take you beyond the guidebooks and deep into the heart of India’s heritage, culture, nature, and spirituality.</p>
                        <p class="mb-4">From the snow-kissed peaks of the Himalayas to the golden sands of Rajasthan, from sacred rivers to ancient temples, and from bustling cities to serene villages—we craft immersive travel experiences that celebrate the essence of India.</p>
                        </b>
                        ...
                        <a class="btn btn-primary rounded-pill py-3 px-5 mt-2" href="https://www.wikipedia.org/">Read More</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-pills d-inline-flex justify-content-center mb-5">
                        ...
                        <li class="nav-item">
                            <a class="d-flex py-2 mx-3 border border-primary bg-light rounded-pill" data-bs-toggle="pill" href="#tab-2">
                                <span class="text-dark" style="width: 150px;">MAHARASHTRA</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="d-flex mx-3 py-2 border border-primary bg-light rounded-pill" data-bs-toggle="pill" href="#tab-4">
                                <span class="text-dark" style="width: 150px;">GUJARAT</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex mx-3 py-2 border border-primary bg-light rounded-pill" data-bs-toggle="pill" href="#tab-5">
                                <span class="text-dark" style="width: 150px;">DELHI</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="destination-overlay p-4">
                                                    ...
                                                    <h4 class="text-white mb-2 mt-3">Delhi City</h4>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="destination-overlay p-4">
                                                    <a href="#" class="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                                    <h4 class="text-white mb-2 mt-3">Mumbai City</h4>
                                                    <a href="#" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a>
                                                </div>
                                                <div class="search-icon">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="destination-overlay p-4">
                                                    <a href="#" class="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                                    <h4 class="text-white mb-2 mt-3">Pune City</h4>
                                                    <a href="#" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a>
                                                </div>
                                                <div class="search-icon">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="destination-overlay p-4">
                                                    <a href="#" class="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                                    <h4 class="text-white mb-2 mt-3">Banglore City</h4>
                                                    <a href="#" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a>
                                                </div>
                                                <div class="search-icon">
                                ...
                                <div class="col-xl-4">
                                    <div class="destination-img h-100">
                                        ...
                                        <div class="destination-overlay p-4">
                                            <a href="#" class="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                            <h4 class="text-white mb-2 mt-3">New Mumbai City</h4>
                                            <a href="#" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a>
                                        </div>
                                        <div class="search-icon">
                                ...
                                <div class="col-lg-4">
                                    <div class="destination-img">
                                        ...
                                        <div class="destination-overlay p-4">
                                            <a href="#" class="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                            <h4 class="text-white mb-2 mt-3">Chennai City</h4>
                                            <a href="#" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a>
                                        </div>
                                        <div class="search-icon">
                                ...
                                <div class="col-lg-4">
                                    <div class="destination-img">
                                        ...
                                        <div class="destination-overlay p-4">
                                            <a href="#" class="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                            <h4 class="text-white mb-2 mt-3">Kolkatta City</h4>
                                            <a href="#" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a>
                                        </div>
                                        <div class="search-icon">
                                ...
                                <div class="col-lg-4">
                                    <div class="destination-img">
                                        ...
                                        <div class="destination-overlay p-4">
                                            <a href="#" class="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                            <h4 class="text-white mb-2 mt-3">Rajasthan</h4>
                                            <a href="#" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a>
                                        </div>
                                        <div class="search-icon">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="destination-img">
                                        ...
                                        <div class="destination-overlay p-4">
                                            <a href="#" class="btn btn-primary text-white rounded-pill border py-2 px-3">20 Photos</a>
                                            <h4 class="text-white mb-2 mt-3">Lucknow</h4>
                                            <a href="#" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a>
                                        </div>
                                        <div class="search-icon">
                                            <a href="img/destination-6.jpg" data-lightbox="destination-6"><i class="fa fa-plus-square fa-1x btn btn-light btn-lg-square text-primary"></i></a>
                ...
                <div class="packages-carousel owl-carousel">
                    <div class="packages-item">
                        <div class="packages-img">
                            ...
                            <div class="packages-price py-2 px-4">₹9999</div>
                        </div>
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Pune - Maharashtra</h5>
                                ...
                                <p class="mb-4">Book the Awesome package of Pune in low price to showcase the beauty of Pune's nature and spiriyuality of god.</p>
                            </div>
                            <div class="row bg-primary rounded-bottom mx-0">
                                <div class="col-6 text-start px-0">
                                    <a href="https://www.wikipedia.org/" class="btn-hover btn text-white py-2 px-4">Read More</a>
                                </div>
                                <div class="col-6 text-end px-0">
                                    <a href="#mybook" class="btn-hover btn text-white py-2 px-4">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                ...
                                <p class="mb-4">The historical and cultural place to visit with our affordable package with cleaver guides.</p>
                            </div>
                            <div class="row bg-primary rounded-bottom mx-0">
                                <div class="col-6 text-start px-0">
                                    <a href="https://www.wikipedia.org/" class="btn-hover btn text-white py-2 px-4">Read More</a>
                    ...
                    <div class="packages-item">
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Discover Rajasthan</h5>
                                <small class="text-uppercase">Hotel Deals</small>
                                <div class="mb-3">
                                    <small class="fa fa-star text-primary"></small>
                                    <small class="fa fa-star text-primary"></small>
                                ...
                                <p class="mb-4">Explore the land of camels and India’s desert forest with our guides and cheap package.</p>
                            </div>
                            <div class="row bg-primary rounded-bottom mx-0">
                                <div class="col-6 text-start px-0">
                                    <a href="https://www.wikipedia.org/" class="btn-hover btn text-white py-2 px-4">Read More</a>
                    ...
                    <div class="packages-item">
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                ...
                                <p class="mb-4">Explore the worlds biggest statue at the gujarat Statue of unity and many more with our package.</p>
                            </div>
                            <div class="row bg-primary rounded-bottom mx-0">
                                <div class="col-6 text-start px-0">
        ...
        <div class="container-fluid booking py-5">
            <div class="container py-5">
                <div class="row g-5 align-items-center" id="mybook">
                    <div class="col-lg-6">
                        ...
                        <a href="https://www.wikipedia.org/" class="btn btn-light text-primary rounded-pill py-3 px-5 mt-2">Read More</a>
                    </div>
                    <div class="col-lg-6">
                        <h1 class="text-white mb-3">Book A Tour Deals</h1>
                        <p class="text-white mb-4">Get <span class="text-warning">50% Off</span> On Your First Adventure Trip With Timeless Bharat. Get More Deal Offers Here.</p>
                        <form action="bookstore.php" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" class="form-control bg-white border-0"name="Email" id="email" placeholder="Your Email">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select name="desti" class="form-select bg-white border-0" id="select1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select name="persones" class="form-select bg-white border-0" id="SelectPerson">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="massge" class="form-control bg-white border-0" placeholder="Special Request" id="message" style="height: 100px"></textarea>
                                        <label for="message">Special Request</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-primary text-white w-100 py-3" name="submitmy" type="submit">Book Now</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="container-fluid guide py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">Project Members</h5>
                ...
                <div class="row g-4">
                        ...
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/shraddha.jpeg" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                            ...
                            <div class="guide-title text-center rounded-bottom p-4">
                                <div class="guide-title-inner">
                                    <h4 class="mt-3">Shraddha Sutar</h4>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/sul.jpeg" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                                <div class="guide-icon rounded-pill p-2">
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                            ...
                            <div class="guide-title text-center rounded-bottom p-4">
                                <div class="guide-title-inner">
                                    <h4 class="mt-3">Dnyaneshwari Sule</h4>
                                    <p class="mb-0">Developer</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/san.jpeg" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                                <div class="guide-icon rounded-pill p-2">
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                            ...
                            <div class="guide-title text-center rounded-bottom p-4">
                                <div class="guide-title-inner">
                                    <h4 class="mt-3">Sanika Sonavane</h4>
                                    <p class="mb-0">Developer</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/sid.jpeg" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                                <div class="guide-icon rounded-pill p-2">
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                            ...
                            <div class="guide-title text-center rounded-bottom p-4">
                                <div class="guide-title-inner">
                                    <h4 class="mt-3">Siddhi Kulthe</h4>
                                    <p class="mb-0">Developer</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/Rohit.jpeg" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                                <div class="guide-icon rounded-pill p-2">
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/niranjan.jpeg" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                                <div class="guide-icon rounded-pill p-2">
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                            ...
                            <div class="guide-title text-center rounded-bottom p-4">
                                <div class="guide-title-inner">
                                    <h4 class="mt-3">Niranjan Sutar</h4>
                                    <p class="mb-0">Developer</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/amar.jpeg" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                                <div class="guide-icon rounded-pill p-2">
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item">
                            ...
                            <div class="blog-content border border-top-0 rounded-bottom p-4">
                                ...
                                <a href="https://www.wikipedia.org/" class="btn btn-primary rounded-pill py-2 px-4">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                ...
                <div class="testimonial-carousel owl-carousel">
                    <div class="testimonial-item text-center rounded pb-4">
                        <div class="testimonial-comment bg-light rounded p-4">
                            <p class="text-center mb-5">I was glad to met with the timeless bharat, there service was absolutely great and I am thankful to guide also.
                            </p>
                        </div>
                        <div class="testimonial-img p-1">
                            <img src="img/shinde.jpeg" class="img-fluid rounded-circle" alt="Image">
                        </div>
                        <div style="margin-top: -35px;">
                            <h5 class="mb-0">Shriyash Shinde</h5>
                            <p class="mb-0">Pune, Maharashtra</p>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        <div class="testimonial-comment bg-light rounded p-4">
                            <p class="text-center mb-5">The service by team was very good and i liked it i will try it for my text surely and thank you Timeless Bharat team.
                            </p>
                        </div>
                        <div class="testimonial-img p-1">
                            <img src="img/garry.jpeg" class="img-fluid rounded-circle" alt="Image">
                        </div>
                        <div style="margin-top: -35px;">
                            <h5 class="mb-0">Gaurav Thorat</h5>
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        <div class="testimonial-comment bg-light rounded p-4">
                            <p class="text-center mb-5">I liked the service of timeless bharat it very good and affordable packages good information is provided by the team.
                            </p>
                        </div>
                        <div class="testimonial-img p-1">
                            <img src="img/shaikh.jpeg" class="img-fluid rounded-circle" alt="Image">
                        </div>
                        <div style="margin-top: -35px;">
                            <h5 class="mb-0">Shahid Shaikh</h5>
                            <p class="mb-0">Konkan , Maharashtra</p>
                            <div class="d-flex justify-content-center">
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href=""><i class="fas fa-home me-2"></i> Pune, Maharashtra, INDIA</a>
                            <a href=""><i class="fas fa-envelope me-2"></i> timelessbharat@gmail.com</a>
                            <a href=""><i class="fas fa-phone me-2"></i> +91 9067722092</a>
                            <a href="" class="mb-3"><i class="fas fa-print me-2"></i> +91 8237966061</a>
